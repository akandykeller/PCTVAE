...
from pctvae.containers.tvae import PCTVAE
...
from pctvae.containers.grouper import Causal_Capsules_from_Gaussian_1d
...
def main():
    ...
    name = 'PCTVAE_MNIST_Causal_L=9/36(only_9_ones)_K=3'
